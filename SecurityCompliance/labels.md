...
### <a name="auto-apply-labels-to-content-with-keywords"></a>Application automatique d’étiquettes à du contenu avec des mots clés
...
Les étiquettes basées sur une requête utilisent l’index de recherche pour identifier le contenu.
