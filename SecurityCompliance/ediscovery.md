...
Office 365 fournit les outils de découverte électronique suivants :
  
- [Contenu de recherche dans la sécurité Office 365 &amp; centre de conformité](ediscovery.md#contentsearch)
...
Le tableau suivant contient des liens vers des rubriques qui vous aideront à utiliser l’outil de recherche de contenu de la sécurité &amp; centre de conformité.
  
|**Rubrique**|**Description**|
|:-----|:-----|
|[Exécuter une recherche de contenu de la sécurité Office 365 &amp; centre de conformité](run-a-content-search-in-the-security-and-compliance-center.md) <br/> |Découvrez comment utiliser l’outil de recherche de contenu pour rechercher les boîtes aux lettres, les dossiers publics, Office 365 groupes Teams Microsoft SharePoint en ligne, des sites, un lecteur pour des sites et Skype pour des conversations dans votre organisation Office 365 en une seule recherche.  <br/> |
|[Requêtes par mots clés et conditions de recherche pour la recherche de contenu](keyword-queries-and-search-conditions.md) <br/> |En savoir plus sur les propriétés de fichier et de messagerie et les conditions de recherche que vous pouvez utiliser pour la recherche de contenu dans les boîtes aux lettres et des sites dans votre organisation Office 365.  <br/> |
|[Afficher les statistiques de mots clés pour les résultats de recherche de contenu](view-keyword-statistics-for-content-search.md) <br/> |Découvrez comment utiliser les statistiques de la recherche pour afficher et comparer les statistiques pour une ou plusieurs recherches de contenu et pour configurer des recherches de nouveaux et existants pour retourner les statistiques pour chaque mot clé dans la requête de recherche.  <br/> |
|[Modification en bloc des recherches de contenu de sécurité Office 365 &amp; centre de conformité](bulk-edit-content-searches.md) <br/> |Découvrez comment modifier les requêtes de recherche et les emplacements de contenu d’une ou plusieurs recherches de contenu.  <br/> |
|[Exporter les résultats de recherche à partir de la sécurité de 365 Office &amp; centre de conformité](export-search-results.md) <br/> |Découvrez comment exporter les résultats d’une recherche de contenu.  <br/> |
|[Augmenter la vitesse de téléchargement lors de l’exportation des résultats de recherche de découverte électronique à partir d’Office 365](increase-download-speeds-when-exporting-ediscovery-results.md) <br/> |Découvrez comment configurer le Registre de Windows sur votre ordinateur pour augmenter la vitesse de téléchargement avec l’exportation des résultats de recherche de contenu.  <br/> |
|[Exporter un rapport de recherche de contenu](export-a-content-search-report.md) <br/> |Découvrez comment télécharger le rapport d’exportation sans avoir à exporter les résultats de recherche.  <br/> |
...
Le tableau suivant contient des liens vers des rubriques qui vous aideront à utiliser les cas eDiscovery dans la sécurité &amp; centre de conformité. Cas d’utilisation pour ajouter des membres qui peuvent accéder à la casse, placer une suspension sur les emplacements de contenu pertinents pour le cas, associer plusieurs recherches de contenu à la casse et exporter les résultats de recherche à partir de la casse.
  
|**Rubrique**|**Description**|
|:-----|:-----|
|[Gérer des affaires eDiscovery de sécurité Office 365 &amp; centre de conformité](manage-ediscovery-cases.md) <br/> |Découvrez comment créer et gérer des affaires eDiscovery dans la sécurité &amp; centre de conformité.  <br/> |
|[Affecter des autorisations de découverte électronique dans le Office?? ? Sécurité 365 &amp; centre de conformité](assign-ediscovery-permissions.md) <br/> |Découvrez comment attribuer des autorisations de découverte électronique dans la sécurité &amp; centre de conformité. Vous pouvez attribuer des autorisations pour permettre aux utilisateurs de créer des cas de découverte électronique, créer des suspensions associées à un cas eDiscovery, exécuter des recherches de contenu, afficher un aperçu des résultats de la recherche et exporter les résultats de recherche.  <br/> |
|[Créer un rapport sur les suspensions dans les cas eDiscovery dans Office 365](create-a-report-on-holds-in-ediscovery-cases.md) <br/> |Découvrez comment utiliser le script Windows PowerShell dans cet article pour générer un rapport qui contient des informations sur toutes les suspensions qui sont associés à des cas eDiscovery dans la sécurité &amp; centre de conformité.  <br/> |
|[Utiliser un script pour ajouter des utilisateurs à une suspension dans un cas de découverte électronique de sécurité Office 365 &amp; centre de conformité](use-a-script-to-add-users-to-a-hold-in-ediscovery.md) <br/> |Découvrez comment utiliser le script Windows PowerShell dans cet article pour ajouter rapidement des boîtes aux lettres et pour obtenir une liste d’utilisateurs à une suspension nouveau associé à un cas de découverte électronique dans la sécurité des sites OneDrive entreprise &amp; centre de conformité.  <br/> |
|[Rechercher des activités de découverte électronique dans le journal d’audit d’Office 365](search-for-ediscovery-activities-in-the-audit-log.md) <br/> |Découvrez comment rechercher dans le journal d’audit Office 365 pour des activités liées à la création et la gestion des cas eDiscovery et des recherches de contenu.  <br/> |
...
|[Exportation des données du cas avec eDiscovery avancée](export-case-data-in-advanced-ediscovery.md) <br/> |Comprendre les instructions pour l’exportation des données de cas eDiscovery et les résultats de la révision externe.  <br/> |
|[Augmenter la vitesse de téléchargement lors de l’exportation des résultats de recherche de découverte électronique à partir d’Office 365](increase-download-speeds-when-exporting-ediscovery-results.md) <br/> |Découvrez comment configurer le Registre Windows pour augmenter la vitesse de téléchargement lors de l’exportation des données de cas de découverte électronique avancée.  <br/> |
