...
Le widget inclut un lien vers le Score de sécuriser Microsoft, qui permet d’accéder à votre tableau de bord de Score d’informations sécurisé pour Office 365.

![Tableau de bord de Score d’informations sécurisé](media/SecureScore-WelcomeScreen.png)

> [!NOTE]
> Vous devez être un administrateur Office 365, tel qu’un administrateur global ou l’administrateur de la sécurité, pour accéder aux Score d’informations sécurisé.
  
## <a name="how-it-works"></a>Fonctionnement

Sécurisation du Score illustrations des services Office 365 que vous utilisez (tels que OneDrive, SharePoint et Exchange) puis examine les paramètres et les activités et les compare à une base établie par Microsoft. Vous obtiendrez un score dépendent de comment aligné avec les meilleures pratiques de sécurité.
  
Vous aurez également des recommandations sur les étapes à que suivre pour améliorer le score de votre organisation. 
...
Si vous rencontrez des problèmes, faites-le nous savoir en le publiant dans la [Office sécurité, de confidentialité &amp; Communauté conformité](hhttps://techcommunity.microsoft.com/t5/Security-Privacy-Compliance/bd-p/security_privacy). Nous vous surveillez la Communauté et fournir une aide.
