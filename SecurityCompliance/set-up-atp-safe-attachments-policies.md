...
## <a name="set-up-an-atp-safe-attachments-policy"></a>Configurer une stratégie de pièces jointes sûres DAV
...
## <a name="learn-about-atp-safe-attachments-policy-options"></a>En savoir plus sur les options de stratégie de pièces jointes sûres DAV
