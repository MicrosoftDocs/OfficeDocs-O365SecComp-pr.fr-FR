...
---
# <a name="office-365-email-anti-spam-protection"></a>Protection contre le courrier indésirable de messagerie Office 365
...
[Éviter les courriers électroniques faux positifs marqués comme courrier indésirable à l'aide d'une liste fiable ou d'autres techniques](prevent-email-from-being-marked-as-spam-0.md)
