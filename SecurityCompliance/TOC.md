...
### [Comment Office 365 valide l’adresse De : pour empêcher des attaques d’hameçonnage](how-office-365-validates-the-from-address.md)
...
### [Chiffrement de service avec la clé client pour la FAQ d’Office 365](service-encryption-with-customer-key-faq.md)
...
#### [Pages d’avertissement des liens fiables ATP](atp-safe-links-warning-pages.md)
#### [Configurer une liste d’URL personnalisée « ne pas réécrire »](set-up-a-custom-do-not-rewrite-urls-list-with-atp.md)
#### [Configurer une liste d’URL bloquées personnalisée](set-up-a-custom-blocked-urls-list-wtih-atp.md)
...
### [Office 365 ATP pour SharePoint, OneDrive et Microsoft Teams](atp-for-spo-odb-and-teams.md)
...
### [Suivi des menaces. Nouveauté à noter](threat-trackers.md)
...
### [Préparer le déploiement de la sécurité des applications cloud Office 365](get-ready-for-office-365-cas.md)
### [Activer la sécurité des applications cloud Office 365](turn-on-office-365-cas.md)
### [Stratégies d’activité et alertes dans la sécurité des applications cloud Office 365](activity-policies-and-alerts.md)
