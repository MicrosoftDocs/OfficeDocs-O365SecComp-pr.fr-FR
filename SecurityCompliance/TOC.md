...
## [Contrôle et gestion de l’accès aux données via le service Sécurité des applications cloud](https://docs.microsoft.com/cloud-app-security/what-is-cloud-app-security)
