...
## [Le nouveau Centre de sécurité Microsoft 365 et le Centre de conformité Microsoft 365](microsoft-security-and-compliance.md)
...
### [Secure Score Office 365](office-365-secure-score.md)
## [Accéder au centre de conformité et de sécurité](go-to-the-securitycompliance-center.md)
### [Autorisations dans le Centre de conformité et sécurité](permissions-in-the-security-and-compliance-center.md)
### [Octroi de l’accès au Centre de conformité et sécurité aux utilisateurs](grant-access-to-the-security-and-compliance-center.md)
## [Vue d’ensemble du tableau de bord de sécurité](security-dashboard.md)
## [Utilisez votre abonnement gratuit à Azure Active Directory](use-your-free-azure-ad-subscription-in-office-365.md)
...
### [Restriction de l’accès au contenu à l’aide du chiffrement dans les étiquettes de sensibilité](encryption-sensitivity-labels.md)
### [Appliquer automatiquement une étiquette sensibilité au contenu](apply_sensitivity_label_automatically.md)
...
### [Visionner une présentation étendue du DLP](https://channel9.msdn.com/events/ignite/microsoft-ignite-orlando-2017/brk3111)
## Configurer le DLP
...
### [Création d’un type personnalisé d’informations sensibles dans le Centre de Conformité et Sécurité Office 365 PowerShell](create-a-custom-sensitive-information-type-in-scc-powershell.md)
...
## [Stratégies de conservation](retention-policies.md)
...
## [Rétention fondée sur des événements](event-driven-retention.md)
## [Rétention basée sur des événements](automate-event-driven-retention.md)
## [Gestionnaire de plan de fichiers](file-plan-manager.md)
## [Création et publication en bloc d’étiquettes de rétention à l’aide de PowerShell](https://docs.microsoft.com/en-us/office365/securitycompliance/bulk-create-publish-labels-using-powershell)

# Gérer la gouvernance des données
## [Importation des données](importing-pst-files-to-office-365.md)
...
### [Afficher l’utilisation d’étiquette avec les analytiques d’étiquette](label-analytics.md)
### [Affichage des rapports de gouvernance des données](view-the-data-governance-reports.md)
...
# [Protéger contre les menaces](protect-against-threats.md)
...
### [Guide de démarrage rapide : Configurer le système d’Office 365 ATP](checklist-atp-setup.md)
...
#### [Livraison et aperçu dynamique](dynamic-delivery-and-previewing.md)
...
#### [Rechercher et examiner le courrier électronique malveillant qui a été distribué](investigate-malicious-email-that-was-delivered.md)
...
## [Protection anti-hameçonnage](tuning-anti-phishing.md)
...
### [Protection du courrier Office 365 contre le courrier indésirable](anti-spam-protection.md)
### [Empêcher le courrier d’être marqué comme courrier indésirable dans Office 365](prevent-email-from-being-marked-as-spam.md)
...
### [Configuration de stratégies anti-programme malveillant](configure-anti-malware-policies.md)
...
### [Protection contre l’usurpation d’identité dans Office 365](anti-spoofing-protection.md)
...
#### [Déclaration de confidentialité du portail de la visionneuse de messages protégés pour Office 365](protected-message-viewer-portal-privacy-statement.md)
...
#### [Configuration de la Gestion des droits relatifs à l’information (IRM) pour utiliser un serveur AD RMS local](configure-irm-to-use-an-on-premises-ad-rms-server.md)
...
#### [Fonctionnalités de chiffrement gérés par client](office-365-customer-managed-encryption-features.md)
...
##### [Stratégies de session dans la sécurité des applications cloud Office 365](ocas-session-policies.md)
##### [Stratégies d’accès dans la sécurité des applications cloud Office 365](ocas-access-policies.md)
...
#### [Examiner une activité concernant la sécurité des applications cloud Office 365](investigate-an-activity-in-office-365-cas.md)
#### [Gérer les applications OAuth à l’aide de la sécurité des applications cloud Office 365](manage-app-permissions-in-ocas.md)
#### [Historique de trafic web et sources de données pour la sécurité des applications cloud Office 365](web-traffic-logs-and-data-sources-for-ocas.md)
...
# [Gérer les enquêtes juridiques](manage-legal-investigations.md)
...
#### [Détection des quasi-duplicatas](compliance20/near-duplicates.md)
...
## [eDiscovery (découverte électronique) avancée Office 365](office-365-advanced-ediscovery.md)
...
#### [Préparation des données pour Advanced eDiscovery](prepare-data-for-advanced-ediscovery.md)
...
#### [Exporter des données](export-results-in-advanced-ediscovery.md)
...
## [Gestionnaire de conformité](meet-data-protection-and-regulatory-reqs-using-microsoft-cloud.md)
...
## [Certification du service dans le Centre de sécurité et conformité Office 365](service-assurance.md)
...
### [Gérer les autorisations de groupe de rôles d’administrateur dans EOP](eop/manage-admin-role-group-permissions-in-eop.md)
...
## [Dépannage et informations relatives au support](troubleshooting-and-support-information.md)
...
### [Accessibilité aux personnes handicapées](eop/accessibility-for-people-with-disabilities.md)
...
# [Office 365 pour entreprises](https://docs.microsoft.com/Office365/Enterprise)
