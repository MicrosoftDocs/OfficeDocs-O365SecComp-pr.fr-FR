...
1. [Passez en revue les conditions préalables](set-up-atp-anti-phishing-policies.md#phishprereq)
    
2. [En savoir plus sur les options de stratégie anti-hameçonnage DAV](set-up-atp-anti-phishing-policies.md#phishpolicyoptions)
    
3. [Configurer une stratégie d’anti-hameçonnage DAV](set-up-atp-anti-phishing-policies.md#addphishpolicy)
...
5. Spécifiez le nom, description et paramètres de votre stratégie. Pour plus d’informations, consultez la rubrique [en savoir plus sur les options de stratégie anti-hameçonnage DAV](set-up-atp-anti-phishing-policies.md#phishpolicyoptions) . 
...
|Appliqué à  <br/> |Sélectionnez **le domaine du destinataire**. Sous **une de ces**, sélectionnez **Choisir**. Sélectionnez **+ Ajouter**. Activez la case à cocher en regard du nom du domaine, par exemple, contoso.com, dans la liste, puis sélectionnez **Ajouter**. Cliquez sur **terminé**.<br/> |
