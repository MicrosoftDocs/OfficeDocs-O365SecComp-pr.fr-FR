...
- **Stratégie** : utilisez ce filtre pour afficher les alertes correspondant au paramètre d’une ou de plusieurs stratégies d’alerte. Sinon, vous pouvez simplement afficher toutes les alertes pour toutes les stratégies d’alerte.
