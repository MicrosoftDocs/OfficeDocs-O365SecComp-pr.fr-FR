...
- Vous pouvez créer des alertes pour les mêmes opérations que vous pouvez rechercher dans le journal d’audit d’Office 365. Afficher les [informations plus](#more-information) section pour obtenir la liste des scénarios courants (et l’activité spécifique à surveiller) que vous pouvez créer des alertes pour. 
...
3. Dans la page **alertes d’activité** , cliquez sur ![icône Ajouter](media/8ee52980-254b-440b-99a2-18d068de62d3.gif) **New**.

   La page flottant pour créer une alerte de l’activité s’affiche.

    
    ![Créer une alerte de l’activité](media/53888bd5-9fa2-4398-8ccc-1a9dc72517ac.png)
  
4. Renseignez les champs suivants pour créer une alerte de l’activité :
    ...
    c. le **type d’alerte** : Assurez-vous que l’option **personnalisé** est sélectionnée. 

    d. **envoi cette alerte lorsque** - cliquez sur **Envoyer cette alerte quand** , puis configurer ces deux champs :
...
4. Dans la page **Modifier l’alerte** , cliquez sur le bouton bascule **sur** pour modifier le statut à **désactiver**, puis cliquez sur **Enregistrer**.
    
    L’état de l’alerte dans les pages des **alertes d’activité** est définie sur **désactiver**. 
