...
- Pourquoi importer des fichiers PST vers Office 365?
  ...
  - Elle permet de répondre aux besoins de conformité de votre organisation en vous permettant d'appliquer les fonctionnalités de conformité d'Office 365 aux données des fichiers PST que vous avez importés. Celles-ci incluent les valeurs suivantes :
