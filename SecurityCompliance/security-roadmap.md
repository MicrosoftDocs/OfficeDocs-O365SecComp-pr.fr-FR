...
|:-----|:-----|
|Domaine  <br/> |Tasks  <br/> |
|Gestion de la sécurité  <br/> |• Vérifier le score sécurisé et noter votre score actuel ( [https://securescore.office.com](https://securescore.office.com)).  <br/>  • Activez la journalisation d'audit pour Office 365. Voir [Rechercher dans le journal d'audit dans le centre &amp; de sécurité conformité Office 365](search-the-audit-log-in-security-and-compliance.md).<br/> • [Configurez votre client Office 365 pour renforcer la sécurité](tenant-wide-setup-for-increased-security.md) .  <br/>  • Examen régulier des tableaux de bord et des rapports dans le centre de sécurité et de conformité Office 365 et dans la sécurité des applications Cloud.  <br/> |
