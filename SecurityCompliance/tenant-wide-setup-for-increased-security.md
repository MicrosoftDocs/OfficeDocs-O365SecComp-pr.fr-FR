...
## <a name="tune-threat-management-policies-in-the-office-365-security-amp-compliance-center"></a>Réglage des stratégies de gestion des menaces dans le &amp; Centre de sécurité conformité Office 365
...
De nombreux contrôles de sécurité et de protection dans le centre d'administration Exchange sont également inclus dans le centre de sécurité et de conformité. Vous n'avez pas besoin de les configurer aux deux emplacements. Voici quelques paramètres supplémentaires qui sont recommandés. 
