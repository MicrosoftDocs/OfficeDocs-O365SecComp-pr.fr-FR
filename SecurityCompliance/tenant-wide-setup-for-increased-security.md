...
|:-----|:-----|
|Tableau de bord de gestion des menaces  <br/> |Dans la section gestion des menaces du &amp; Centre de sécurité conformité, utilisez ce tableau de bord pour voir les menaces qui ont déjà été gérées, et en tant qu'outil pratique pour la création de rapports auprès des décideurs d'entreprise sur l'intelligence des menaces déjà effectuée pour sécuriser votre gestion.  <br/> |
