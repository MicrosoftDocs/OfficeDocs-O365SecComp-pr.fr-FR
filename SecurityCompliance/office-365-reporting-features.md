...
Pour plus d'informations, consultez [la rubrique rapports d'activité dans le centre d'administration Office 365](https://support.office.com/article/activity-reports-in-the-office-365-admin-center-0d6dfb17-8582-4172-a9a9-aed798150263).
...
|----------------------------|-------------------------------------------------------------------------|
| Users. csv | Tous les utilisateurs nouveaux, en attente et suspendus dans le réseau |
...
| Rubriques. csv | Rubriques créées sur le réseau |
