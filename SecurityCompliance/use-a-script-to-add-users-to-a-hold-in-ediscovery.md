...
3. <span data-ttu-id="f10f1-167">Exécutez le script; par exemple:</span><span class="sxs-lookup"><span data-stu-id="f10f1-167">Run the script; for example:</span></span>
