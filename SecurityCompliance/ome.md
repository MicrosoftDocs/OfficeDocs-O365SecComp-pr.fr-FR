...
Cet article fait partie d’une plus grande série d’articles sur Office 365 Message Encryption. Utilisez le tableau suivant pour trouver rapidement les informations dont vous avez besoin.
  
|||
|:-----|:-----|
|Lisez cet article...  <br/> |Si vous êtes...  <br/> |
|[En savoir plus sur les messages protégés dans Office 365](https://support.office.com/article/2baf3ac7-12db-40a4-8af7-1852204b4b67.aspx) <br/> |Un utilisateur final qui souhaite en savoir plus sur la façon chiffré messages travail et quelles options sont disponibles pour vous.  <br/> |
|[Comment ouvrir un message protégé ?](https://support.office.com/article/1157a286-8ecc-4b1e-ac43-2a608fbf3098.aspx) <br/> |Un utilisateur final qui lisent un message protégé qui vous a été envoyé. Cet article contient des informations sur la lecture des messages dans plusieurs versions d’Outlook et de comptes de messagerie différents, y compris celles en dehors d’Office 365 tels que gmail et comptes Yahoo!.  <br/> |
|[Envoyer, consulter et répondre aux messages chiffrés dans Outlook](https://support.office.com/article/eaa43495-9bbb-4fca-922a-df90dee51980.aspx) <br/> |Un utilisateur qui souhaite envoyer, afficher, ou répondre à un message chiffré à partir d’Outlook. Même si vous n’êtes pas un membre d’une organisation Office 365, vous recevrez des notifications de messages chiffrés envoyé dans Outlook. Utilisez cet article pour obtenir des instructions sur la procédure pour afficher et répondre à des messages chiffrés envoyés à partir d’Office 365.  <br/> |
|[Envoyer un message signé numériquement ou chiffré](https://support.office.com/article/a18ecf7f-a7ac-4edd-b02e-687b05eff547) <br/> |Un utilisateur qui souhaite envoyer, afficher, ou répondre à des messages chiffrés à l’aide d’Outlook pour Mac. Cet article traite également à l’aide des méthodes de chiffrement autre que OME, telles que S/MIME.  <br/> |
...
Lorsqu’une personne envoie un message électronique dans Exchange Online qui correspond à une règle de flux de messagerie de chiffrement, le message est chiffré avant son envoi. Tous les utilisateurs finals d’Office 365 qui utilisent les clients Outlook pour lire le courrier recevoir native, des expériences pour le courrier électronique chiffré et protégé par des droits de lecture, même si elles ne sont pas dans la même organisation que l’expéditeur. Les clients Outlook pris en charge sont Outlook du bureau, Mac Outlook, Outlook mobile sur iOS et Android et Outlook Web App.
  
Destinataires de messages chiffrés qui reçoivent des messages chiffrés ou protégés par des droits envoyés à leurs comptes Outlook.com, Gmail ou Yahoo peuvent facilement s’authentifier sur le portail OME à l’aide de leur compte Microsoft ou les informations d’identification Gmail ou Yahoo.
  
Les utilisateurs finaux qui lire des messages chiffrés ou protégés par des droits sur des clients autres que Outlook permet également le portail OME pour afficher qu’ils reçoivent les messages chiffrés et protégés par des droits.
...
Règles de flux de messagerie sont flexibles, ce qui vous permet de combiner des conditions pour satisfaire des exigences de sécurité spécifiques dans une règle unique. Par exemple, vous pouvez créer une règle pour chiffrer tous les messages qui contiennent des mots clés spécifiés et sont adressés à des destinataires externes. Les nouvelles fonctionnalités d’Office 365 Message Encryption également chiffrer des réponses de destinataires de courrier électronique chiffré.
