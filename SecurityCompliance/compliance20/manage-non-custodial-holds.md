...
---
# <a name="rename-this-page-and-md-file-to-managing-holds"></a>Renommer cette page et le fichier MD à « Gestion des suspensions »

# <a name="holds-in-advanced-ediscovery-preview"></a>SUSPENSIONS d’eDiscovery avancée (Preview)
...
## <a name="manage-custodian-based-holds"></a>Gérer les suspensions en fonction de dépositaire
