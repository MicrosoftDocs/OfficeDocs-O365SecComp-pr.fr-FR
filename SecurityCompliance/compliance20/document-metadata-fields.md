...
|Custodian                  | Oui (dépositaire)                                 |                         | Oui         |
|Source de données                | Oui (source)                                    |                         | Oui         |
|Date                       | Oui (date)                                      |                         | Oui         |
...
|Titre du document                  | Oui (titre)                                     |                         | Oui         |
|Version du document                |                                                 |                         | Oui         |
|Thème dominant             | Oui (dominantTheme)                             |                         | Oui         |
...
|Date de réception du message électronique        | Oui (reçu)                                  |                         | Oui         |
|Date d'envoi du message électronique            | Oui (envoyé)                                      |                         | Oui         |
...
|Expéditeur du courrier électronique               | Oui (expéditeur)                                    |                         | Oui         |
|Domaine de l'expéditeur du courrier électronique        | Oui (senderDomain)                              |                         | Oui         |
|Sensibilité du courrier électronique          |                                                 |                         | Oui         |
|Message électronique                  | Oui (emailSetId)                                |                         | Oui         |
|Objet du message              | Oui (objet)                                   |                         | Oui         |
...
|ID de famille                  | Oui (familyId)                                  |                         | Oui         |
|Taille de la famille                |                                                 |                         | Oui         |
|Classe file                 | Oui (fileClass)                                 |                         | Oui         |
|ID de fichier                    | Oui (fileId)                                    |                         | Oui         |
|Comporte du texte                   |                                                 |                         | Oui         |
|Type inClusif             | Oui (inclusiveType)                             |                         | Oui         |
|Date d'entrée modifiée        |                                                 |                         | Oui         |
|ID du fichier d'entrée              |                                                 |                         | Oui         |
|Chemin d'entrée                 |                                                 |                         | Oui         |
|Identificateur du message Internet        |                                                 |                         | Oui         |
|Est représentatif          | Oui (markAsRepresntative)                       |                         | Oui         |
|Classe de l’élément                 |                                                 |                         | Oui         |
|ID de chargement                    | Oui (loadId)                                    |                         | Oui         |
|Nom de l'emplacement              |                                                 |                         | Oui         |
|Marqué comme tableau croisé dynamique            | Oui (markAsPivot)                               |                         | Oui         |
|Type de message               | Oui (messageKind)                               |                         | Oui         |
|Extension native           |                                                 |                         | Oui         |
|Nom de fichier natif           |                                                 |                         | Oui         |
|MD5 natif                 |                                                 |                         | Oui         |
|SHA Native 256             |                                                 |                         | Oui         |
|Taille native                | Oui (taille)                                      |                         | Oui         |
|Type natif                | Oui (fileType)                                  |                         | Oui         |
