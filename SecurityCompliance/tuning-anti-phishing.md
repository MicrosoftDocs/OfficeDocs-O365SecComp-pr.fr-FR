...
- Sur une base mensuelle, exécutez le [score sécurisé](microsoft-secure-score.md) pour évaluer les paramètres de sécurité de votre organisation Office 365.
