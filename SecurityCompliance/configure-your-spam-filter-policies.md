...
12. **Sur** Les messages sont activement filtrés en fonction de la règle associée à cette option. Les messages sont marqués comme courrier indésirable ou leur taux de mise en quarantaine est augmenté en fonction des options que vous activez. 
