...
|**Outil**|**Description**|
|:-----|:-----|
|**Tableau de bord, Explorateur de menaces et incidents** <br/> |Une fois activés, ces volets vous permettent de gérer Office 365 Analytics and Threat Intelligence. Pour plus d'informations, reportez-vous à la rubrique [Office 365 Threat Intelligence Overview](office-365-ti.md).<br/> |
