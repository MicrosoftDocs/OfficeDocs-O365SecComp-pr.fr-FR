...
### <a name="to-manage-whether-or-not-one-time-pass-codes-are-generated-for-ome"></a>Pour gérer les codes secrets unique sont générés pour OME ou non
...
Si vous choisissez de ne pas autoriser les pièces jointes de courrier électronique déchiffré, qui est la valeur par défaut, les utilisateurs reçoivent un message qui indique qu’ils ne possèdent les droits pour afficher les pièces jointes.
...
### <a name="to-manage-whether-or-not-email-attachments-are-decrypted-on-download-from-a-web-browser"></a>Pour gérer ou non les pièces jointes sont déchiffrées au téléchargement à partir d’un navigateur web
